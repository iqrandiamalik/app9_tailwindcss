...
function CSection3() {
    return (
        <div className="flex flex-col wide:flex-row pt-5 pb-10 wide:pt-5 wide:pb-10 justify-center items-center">
            <div className="py-10 mx-10">
                <div className="flex py-5">
                    ...
                    <div className="pl-12">
                        <h2 className="font-bold text-xl font-[poppins]">Address</h2>
                ...
                <div className="flex py-5">
                    ...
                    <div className="pl-12">
                        <h2 className="font-bold text-xl font-[poppins]">Phone
                        </h2>
                ...
                <div className="flex  py-5">
                    ...
                    <div className="pl-12">
                        <h2 className="font-bold text-xl font-[poppins]">Working Time</h2>
            ...
            <div className=" flex flex-col py-10 mx-10">
                <label className="font-bold pt-5">Your Name</label>
                <input type="text" placeholder="Name" className="w-96 h-12 indent-5 border rounded border-gray-300"></input>
                <label className="font-bold pt-5">Email Address</label>
                <input type="email" placeholder="abc@gmail.com" className="w-96 h-12 indent-5 border rounded border-gray-300"></input>
                <label className="font-bold pt-5">Subject</label>
                <input type="text" placeholder="Subject" className="w-96 h-12 indent-5 border rounded border-gray-300"></input>
                <label className="font-bold pt-5">Message</label>
                <input type="text" placeholder="I would like to talk" className="w-96 h-20 indent-5 border rounded border-gray-300"></input>
                <button type="button" className="text-center border-2 bg-yellow-600 py-2 px-3 text-white mt-10 hover:cursor-pointer hover:border-2 hover: border-yellow-600 hover:bg-white hover:text-yellow-600">Submit</button>
            </div>
        </div>
    )
}
